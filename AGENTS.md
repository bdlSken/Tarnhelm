...
Tarnhelm is a **native Android app** (Kotlin + Gradle) for cleaning tracking parameters out of sharing links. There is no backend/server — "running" the project means building the Android APK.
